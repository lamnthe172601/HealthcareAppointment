...
namespace HealthcareAppointment.Models.Migrations
{
    ...
    [Migration("20241015040647_InitialCreate")]
            ...
            modelBuilder.Entity("HealthcareAppointment.Models.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            Date = new DateTime(2024, 10, 16, 11, 6, 46, 859, DateTimeKind.Local).AddTicks(2601),
                            DoctorId = "1",
                            PatientId = "3",
                            Status = 0
                        },
                        ...
                        {
                            Id = "2",
                            Date = new DateTime(2024, 10, 17, 11, 6, 46, 859, DateTimeKind.Local).AddTicks(2614),
                            DoctorId = "2",
                            PatientId = "4",
                            Status = 0
                        },
                        ...
                        {
                            Id = "3",
                            Date = new DateTime(2024, 10, 18, 11, 6, 46, 859, DateTimeKind.Local).AddTicks(2616),
                            DoctorId = "1",
                            PatientId = "5",
                            Status = 0
                        },
                        ...
                        {
                            Id = "4",
                            Date = new DateTime(2024, 10, 19, 11, 6, 46, 859, DateTimeKind.Local).AddTicks(2617),
                            DoctorId = "2",
                            PatientId = "3",
                            Status = 0
                        },
                        ...
                        {
                            Id = "5",
                            Date = new DateTime(2024, 10, 20, 11, 6, 46, 859, DateTimeKind.Local).AddTicks(2619),
                            DoctorId = "1",
                            PatientId = "4",
                            Status = 0
                        });
